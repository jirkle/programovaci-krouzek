...
class Objekt:
	...
	# Konstruktor využitý při Inicializaci objektu
	def __init__():
		self.promenna = 3
...
# A teď si z třídy vytvoříme konkrétní objekt:

instance = Objekt()

# V pravé části přiřazení probíhá vytvoření (inicializace) objektu. Ta funguje tak, že se zavolá konstruktor dané třídy a objekt se uloží do proměnné vlevo.
...
# Konstruktor ve třídě nemusí být uvedený, v tom případě se volá přednastavený (implicitní) konstruktor společný pro všechny objekty.
